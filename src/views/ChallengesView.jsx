  ...
  return (
    <div style={{ maxWidth: 460, margin: "0 auto", fontFamily: "DM Mono, monospace", animation: "fadeIn 0.25s ease" }}>
      ...
      <div style={{ padding: "16px 18px" }}>
        ...
        {showCreate && (
          <div style={{
            background: "var(--bg2)", border: `1px solid ${ACCENT}33`,
            ...
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontSize: 9, color: "var(--text3)", letterSpacing: 2, marginBottom: 6 }}>RIVAL</div>
            ...
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontSize: 9, color: "var(--text3)", letterSpacing: 2, marginBottom: 6 }}>EJERCICIO</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
              <div>
                <div style={{ fontSize: 9, color: "var(--text3)", letterSpacing: 2, marginBottom: 6 }}>OBJETIVO (kg 1RM)</div>
              ...
              <div>
                <div style={{ fontSize: 9, color: "var(--text3)", letterSpacing: 2, marginBottom: 6 }}>PLAZO: {deadlineDays}d</div>
              ...
              return (
                <div key={ch.id} style={{
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 14 }}>
                    <div>
                      <div style={{ fontSize: 9, color: "var(--text3)", letterSpacing: 2, marginBottom: 4 }}>RETO ⚔️</div>
                    ...
                    <div style={{ textAlign: "right" }}>
                      ...
                      {ch.status === "expired" && <div style={{ fontSize: 11, color: "var(--text3)" }}>Expirado</div>}
                      {ch.status === "active" && (
    ...
    <div style={{ marginBottom: 12 }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
        ...
        <span style={{ fontSize: 12, color: current > 0 ? color : "var(--text3)" }}>
          {current > 0 ? `${current} kg` : "—"} <span style={{ color: "var(--text3)", fontSize: 10 }}>/ {target}</span>
        </span>
      </div>
      ...
      <div style={{ fontSize: 9, color: "var(--text3)", textAlign: "right", marginTop: 3 }}>{pct}%</div>
    </div>
  );
}
